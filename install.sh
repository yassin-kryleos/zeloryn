...
printf "Get Involved with Zeloryn (Free & Open Source - GPLv3):\n"
printf "  ⭐ Star on GitHub:     ${BOLD}https://github.com/%s${RESET}\n" "$GITHUB_REPO"
printf "  🤝 Contribute & Docs:  ${BOLD}https://github.com/%s/blob/main/CONTRIBUTING.md${RESET}\n" "$GITHUB_REPO"
printf "  🐛 Report an Issue:    ${BOLD}https://github.com/%s/issues${RESET}\n\n" "$GITHUB_REPO"
