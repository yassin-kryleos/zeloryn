...
- Name: accessibility.e2e.ts >> Mobile app — accessibility (axe WCAG 2.1 A/AA) >> initial page load has no critical/serious violations
- Location: e2e\accessibility.e2e.ts:37:7
